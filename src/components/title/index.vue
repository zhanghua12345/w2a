<template>
  ...
  >
    <view class="flex flex-col">
      <view class="text-32 leading-1.4 flex items-center font-600" v-if="title">
        {{ title }}
        <view
          class="text-22 leading-1.2 pt-14 pl-main font-400 text-tip"
          v-if="subTitle"
        >
          {{ subTitle }}
        </view>
    ...
    <view class="flex items-center" v-if="isMore">
      {{ moreTitle }}
